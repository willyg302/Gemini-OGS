...
public class EmailMethod extends HttpServlet {
    ...
    public static String Perform(String toPerform) {
        ...
        try {
            ...
            Logger.getLogger(EmailMethod.class.getName()).log(Level.SEVERE, null, ex);
     ...
     * 2 - problem sending message
     *  
     */
    
    public static int sendMail(String recipient, String name) 
        ...
        if(Validate(recipient)) {
            ...
            try {
                ...
                msg.setFrom(new InternetAddress("geminiogs@gmail.com",
                        "Gemini Online"));
